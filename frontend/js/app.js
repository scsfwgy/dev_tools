...
(function () {
      ...
      el.innerHTML = `
        <div class="home-page">
          <header class="home-hero">
            ...
            <div>
              <h1>DevTools</h1>
              <p data-i18n="welcome.desc">42+ 个免费开发工具，无需登录，优先在浏览器本地处理</p>
            </div>
          </header>
          ...
          <div class="home-trust-row">
            ...
            <span data-i18n="welcome.toolCount">42+ 个工具</span>
  ...
  var HOME_CATEGORIES = [
    ...
    { id: "games", tools: ["focus", "ball-game", "predator-game", "cycle-game", "war-game"] },
